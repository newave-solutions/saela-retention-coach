...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Tools for Saela Way retention call training. Use `list_sessions` to find the signed-in agent's practice calls, `get_session` for a full scorecard with coaching and transcript, and `performance_summary` for save rate and category trends.",
